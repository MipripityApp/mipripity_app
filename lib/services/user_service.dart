...
class UserService {
  ...
  Future<Map<String, dynamic>?> getUserByEmail(String email) async {
    try {
      // Using the correct endpoint as defined in server.dart
  ...
  Future<Map<String, dynamic>?> getUserSettings(int userId) async {
    try {
      final response = await http.get(
        Uri.parse('$_baseUrl/users/id/$userId/settings'),
        headers: await _getAuthHeaders(),
      );
  ...
  Future<Map<String, dynamic>?> updateNotificationPreferences(
    ...
    try {
      final response = await http.put(
        Uri.parse('$_baseUrl/users/id/$userId/notifications'),
        headers: await _getAuthHeaders(),
  ...
  Future<Map<String, dynamic>?> updateSecuritySettings(
    ...
    try {
      final response = await http.put(
        Uri.parse('$_baseUrl/users/id/$userId/security'),
        headers: await _getAuthHeaders(),
  ...
  Future<bool> changePassword({
    ...
    try {
      final response = await http.put(
        Uri.parse('$_baseUrl/users/id/$userId/password'),
        headers: await _getAuthHeaders(),
        body: jsonEncode({
