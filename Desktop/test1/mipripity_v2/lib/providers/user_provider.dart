  ...
  Future<bool> login(String email, String password) async {
    ...
    try {
      ...
      if (_firebaseUser != null) {
        ...
        if (userData != null) {
          // Step 3: Create complete user profile
          _appUser = app_models.User(
            id: userData['id'] ?? _firebaseUser!.uid.hashCode.abs(),
            email: email,
          ...
          print('✅ User profile loaded: ${_appUser!.firstName} ${_appUser!.lastName}');
        } else {
  ...
  Future<void> _fetchFullUserProfile(String email) async {
    try {
      ...
      if (userData != null) {
        ...
        final userId = userData['id'] ?? userData['user_id'] ?? _firebaseUser!.uid.hashCode.abs();
        ...
        _appUser = app_models.User(
          id: userId is String ? int.parse(userId) : userId,
          email: email,
          firstName: firstName,
          lastName: lastName,
          phoneNumber: phoneNumber,
        ...
        print('Full user profile fetched and saved: ${_appUser!.firstName} ${_appUser!.lastName}');
      } else {
